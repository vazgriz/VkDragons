...
namespace VkDragons {
    public partial class Scene {
        ...
        GraphicsPipeline planePipeline;
        ...
        void CreatePlanePipeline() {
            ShaderModule vert = CreateShader("resources/shaders/plane.vert.spv");
            ShaderModule frag = CreateShader("resources/shaders/plane.frag.spv");
            ...
            using (vert)
            using (frag) {
                planePipeline = new GraphicsPipeline(renderer.Device, info, null);
            }
        }
